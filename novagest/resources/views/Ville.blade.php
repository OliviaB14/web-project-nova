      ...
      <table id="example" class="mdl-data-table responsive-table highlight" cellspacing="0" width="100%">
        ...
        @foreach($villes as $task)
            <tr>
                ...
                <td><a class="btn-floating btn-large waves-effect waves-light red" href="ville/destroy/{{$task->id}}"><i class="material-icons">cancel</i></a><a id="{{$task->id}}" class="btn-floating btn-large waves-effect waves-light yellow edit" href="#modal1"><i class="material-icons">edit</i></a></td>
            </tr>
        @endforeach
        </tbody>
    </table>
